...
const createCompiler = rawOptions => {
	...
	// 将NodeEnvironmentPlugin应用到compiler上，并传入options.infrastructureLogging作为参数。NodeEnvironmentPlugin是用于设置Webpack的环境的插件，通过调用apply方法将其应用到compiler上，以便在Webpack构建过程中进行必要的环境设置和日志记录
